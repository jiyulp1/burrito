...
<head>
    ...
    <link href="/resource/vendor/simple-line-icons/simple-line-icons.min.css" type="text/css" />
...
<!--     <link href="../WebContent/resource/vendor/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" /> -->
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/resource/img/favicon/favicon-16x16.png" />
    ...
    <div class="content-lg container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50 mt-4">
                <div class="margin-b-20">
                    <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="/resource/img/970x647/01.jpg" alt="Latest Products Image">
                    </div>
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50 mt-4">
                <div class="margin-b-20">
                    <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="/resource/img/970x647/content_sub2.png" alt="Latest Products Image">
                    </div>
                </div>
