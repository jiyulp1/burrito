...
<!-- 										<a href="login.jsp" class="btn btn-default mt-4" id="edit">수정하기</a> -->
									...
									<%-- 로그인O--%>
									<c:if test="${member != null }">
<!-- 										<a href="javascript:document.htmlwrite.submit()" class="btn btn-info mt-4" id="writesuccess">작성완료</a> -->
										<button type="submit" class="btn btn-info mt-4" id="writesuccess">작성완료</button>
<%-- 										<a href="${pageContext.request.contextPath }/pages/htmlBoardUpdate.do" class="btn btn-default mt-4" id="editBoard">수정 하기</a> --%>
									</c:if>
