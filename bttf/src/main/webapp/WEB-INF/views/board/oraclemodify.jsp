...
<!--                             </form> -->
							...
							<form name = "oraclemodify" method="post">
								<div class="col-auto">
									<label for="subject">제목</label>
									<input id="subject" name="post_subject" class="form-control margin-b-50" type="text" value="${oracleview.post_subject}">
									<textarea id="editor" name="post_contents" class="form-control" style=" resize: none;">${oracleview.post_contents}</textarea>
								</div>
								<button type="submit" class="btn btn-info mt-4" id="writesuccess">작성완료</button>
								<a class="btn btn-primary mt-4" id="list" onclick="confirm_backlist()">글 목록</a>
							</form>
							<!-- End write Form -->
