...
<!-- root ui -->
<!-- <link href="../../../resources/vendor/root-ui-master/resources/css/root-ui.css" rel="stylesheet"> -->
<style type="text/css">
	.remove {
		display: none;
	}
...
<body class="page-on-scroll ">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="exampleModalLabel">게시글 신고</h4>
				</div>
				...
				<div class="modal-footer">
					...
					<a href="/member/cssboardreported?post_id=${cssview.post_id }&category_id=0" class="btn btn-danger" id="boardreport" type="button" style="float: right;">게시글 신고</a>
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="exampleModalLabel">유저 신고</h4>
				</div>
				<div class="modal-body">
					<form>
						<div class="form-group">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					<a href="/member/memberreport?user_nickname=${cssview.user_nickname }" class="btn btn-danger" id="memberreport" type="button" style="float: right;">작성자 신고</a>
					<!--<button type="button" class="btn btn-primary">작성자 신고</button> -->
				</div>
			</div>
		</div>
	</div>
	...
	<script src="../../../resources/vendor/swiper/js/swiper.jquery.min.js"
		type="text/javascript"></script>
	<script
		src="../../../resources/vendor/masonry/jquery.masonry.pkgd.min.js"
		type="text/javascript"></script>
	<script
		src="../../../resources/vendor/masonry/imagesloaded.pkgd.min.js"
		type="text/javascript"></script>
