                    ...
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                        <div class="my_box" data-height="height">
                            <form method="post">
           					...
           					<!-- 댓글 작성 -->
							<form action="/reply/java_reply_write " name="replyForm" method="post">
								...
								<div>	
									<c:choose>
										<c:when test="${javareplylist != null and fn:length(javareplylist) > 0 }">
											<c:forEach var="reply" items="${javareplylist }">
...
<%-- 																<a class="btn btn-info  mt-4" href="javascript:updateReadonlyReply( ${reply.reply_id} );" id="editsubmitfail" onchange="">수정하기</a> --%>
																...
																<a class="btn btn-danger mt-4" href="/reply/java_reply_delete?reply_id=${reply.reply_id }&post_id=${reply.post_id}" id="list" type="submit">삭제</a>
															</c:if>
															</div>
														</div>
													</c:if>
...
// 			document.replyForm.action = "/reply/java_reply_modify?reply_id="+reply_id;
