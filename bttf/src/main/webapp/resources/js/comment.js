...
/*! livere.tower 2022-03-10, 1:23:38 PM */
var LivereTower = function() {
    ...
    function addEventListener(a, b, c) {
        c = c || window, (bound[a] || (bound[a] = [])).push(b), c.addEventListener ? c.addEventListener(a, b) : c.attachEvent && c.attachEvent("on" + a, b)
    }
    ...
    function setBrowser() {
        return set("browser", function() {
            ...
            return /trident/i.test(c[1]) ? (a = /\brv[ :]+(\d+)/g.exec(b) || [], "IE " + (a[1] || "")) : "Chrome" === c[1] && null != (a = b.match(/\bOPR\/(\d+)/)) ? "Opera " + a[1] : (c = c[2] ? [c[1], c[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (a = b.match(/version\/(\d+)/i)) && c.splice(1, 1, a[1]), c.join(" "))
        }())
    }
    ...
    function template(a, b) {
        ...
        if (a && !(c.indexOf(a) < 0)) return function(a, b) {
            ...
            return b.uuid = uuid, c.title = "livere-" + a, c.scrolling = "no", c.async = !0, c.frameBorder = 0, c.allowTransparency = "true", c.src = "check" === a ? "https://101.livere.co.kr/html/systemCheck.html" : concatURI(d, b, !0), isRestrictIEVersion(7) && (c.scrolling = "auto", c.height = "1000px"), c
        }(a, b)
    }
    ...
    function createMeta(a, b) {
        a.refer, getMetaData("category"), getMetaData("keyword"), getMetaData("reporter");
    ...
    function getMetaData(a) {
        var b, c, d = [];
        "category" === a ? b = ["article:section", "article:section2", "article:section3"] : "keyword" === a ? c = ["property='article:tag'", "name='news_keywords'", "name='keywords'"] : "reporter" === a && (b = ["dable:author", "article:author"], c = ["name='byl'", "name='author'", "name='writer'", "name='twitter:creator'"]), b ? b.map(function(a, b) {
    ...
    function getUUID(a) {
        ...
        if (b) uuid = b, a();
            ...
            request(LIVEREMEURL + "uuid", {
                ...
                c && c.uuid ? (localStorage.setItem("livereUUID", c.uuid), uuid = c.uuid, a()) : console.log("failed to issue livere uuid")
            })
        }
    }
    var livere = {},
    ...
    livere.__version__ = "9.1", livere.init = function() {
        function a() {
            ...
            if (c && (a.extra.forceEagerLoading = c), requestLog(a), d) return location.search.indexOf("redirectOrigin=true") > -1 ? widget.oauth.call(this) : livere.start.call(this);
        ...
        function a() {
            var c = getPosition(b);
            if (isNaN(window.innerHeight) || isNaN(getWindowHeight()) || c.y - getWindowHeight() - window.innerHeight < 100) return removeEventListener("scroll", a, d), location.search.indexOf("redirectOrigin=true") > -1 ? widget.oauth.call(this) : livere.start.call(this)
        }
        ...
        var a = {
            comment: {
                ...
                loaded: function(a, b) {
                    widget.comment.resize(a, b.height), widget.comment.updateParams(), b.dable ? widget.comment.insertDable(b.dable) : widget.comment.insertTaboola(b.taboola)
                },
                resize: function(a, b) {
        ...
        return a.draw = function(a) {
            if (a) {
                ...
                a.style.cssText = "min-width:100%;width:100px;*width:100%;height:250px;overflow:hidden;border:0;z-index:124212;", a.id = b, document.getElementById("lv-container").appendChild(a)
            }
        }, a
        ...
        return a.state = function() {
            ...
            if (a) {
                ...
                return a.style.cssText = "min-width:100%;width:100px;*width:100%;height:500px;overflow:hidden;border:0;z-index:124212;", a.id = c, document.getElementById("lv-container").appendChild(a), b(c)
            }
            ...
            if (a && void 0 !== a.status && !a.status)
                if ("cizion-laibili" === a.accountId) {
                    const b = document,
                        c = b.createElement("script");
                    c.type = "text/javascript", c.text = "window._taboola = window._taboola || []; _taboola.push({article:'auto'}); !function (e, f, u, i) { if (!document.getElementById(i)){ e.async = 1; e.src = u; e.id = i; f.parentNode.insertBefore(e, f); } }(document.createElement('script'), document.getElementsByTagName('script')[0], '//cdn.taboola.com/libtrc/cizion-china-network/loader.js', 'tb_loader_script'); if(window.performance && typeof window.performance.mark == 'function') {window.performance.mark('tbl_ic');}", b.head.appendChild(c);
                    const d = b.querySelector("#lv-container"),
                        e = b.createElement("div");
                    e.id = "taboola-below-article-thumbnails";
                    const f = b.createElement("script");
                    f.type = "text/javascript", f.text = "window._taboola = window._taboola || []; _taboola.push({ mode: 'thumbnails-a', container: 'taboola-below-article-thumbnails', placement: 'Below Article Thumbnails', target_type: 'mix' });", d.after(e), e.after(f);
                    const g = b.createElement("script");
                    g.type = "text/javascript", g.text = "window._taboola = window._taboola || []; _taboola.push({flush: true});", b.body.after(g)
                } else {
                    const h = "taboola-livere";
                    window._taboola = window._taboola || [], _taboola.push({
                            article: "auto"
                        }),
                        function(a, b, c, d) {
                            document.getElementById(d) || (a.async = 1, a.src = c, a.id = d, b.parentNode.insertBefore(a, b))
                        }(document.createElement("script"), document.getElementsByTagName("script")[0], "//cdn.taboola.com/libtrc/" + a.accountId + "/loader.js", "tb_loader_script"), window.performance && "function" == typeof window.performance.mark && window.performance.mark("tbl_ic");
                    const b = document,
                        d = b.querySelector("#lv-container"),
                        e = b.createElement("div");
                    e.id = h, d.parentNode.insertBefore(e, d.nextSibling), window._taboola = window._taboola || [], _taboola.push({
                        mode: "thumbnails-a",
                        container: h,
        ...
        }, a.insertDable = function(a) {
            if (a && void 0 !== a.status && !a.status) {
                if (!(isMobile() ? a.mobile : a.pc)) {
                    const b = a.zoneId,
                        c = a.slotId,
                        d = "dablewidget_" + b,
                        e = document.getElementById("lv-container");
                    var f = document.createElement("div");
                    f.setAttribute("id", d), f.setAttribute("data-widget_id", b), e.appendChild(f), !window.dable && function(a, b, c, d, e, f) {
                        a[c] && a[c].q || (a[c] = function() {
                            (a[c].q = a[c].q || []).push(arguments)
                        }, e = b.createElement(d), e.async = 1, e.charset = "utf-8", e.src = "//static.dable.io/dist/plugin.min.js", f = b.getElementsByTagName(d)[0], f.parentNode.insertBefore(e, f))
                    }(window, document, "dable", "script"), window.dable("setService", c), window.dable("renderWidget", d, {
                        ignore_items: !0
                    })
                }
            }
        ...
        return a.open = function(a) {
            ...
            if (b) {
                ...
                return b.style.cssText = "width:100%;overflow:hidden;border:0;position:fixed;left:0;top:0;z-index:2147483647;display:none", b.style.height = document.documentElement.clientHeight + "px", b.id = d, document.getElementsByTagName("body")[0].appendChild(b), a.attachEvent(), c(d)
            }
            ...
            return get("lv_utils").style.display = "none", removeEventListener("resize", widget.sidebar.resize), postMessage(get("lv_comment").contentWindow, {
                e: "setCurrentFocus"
            })
        ...
        return a.draw = function(a) {
            ...
            if (a) {
                var c = serial("lv-ad");
                return a.style.cssText = "min-width:100%;width:100px;overflow:visible;border:0;z-index:124212;", a.id = c, document.getElementById("lv-container").appendChild(a), b(c)
            }
        }, a.load = function() {
            var a = config.parse(),
                b = atob(a.uid).split("/"),
            ...
            var d = function(a, b, c) {
                    if (!document.querySelector(a + "[" + b + '="' + c[b] + '"]')) {
                ...
                e = function(a) {
                    ...
                    return e.src = b, e.width = c, e.height = d, e.frameBorder = 0, e.marginWidth = 0, e.marginHeight = 0, e.scrolling = "no", e.setAttribute("paddingwidth", 0), e.setAttribute("paddingheight", 0), e.setAttribute("allowtransparency", !0), e.setAttribute("allowfullscreen", !0), e
                },
                f = function(a) {
                    var b = a.livereAds[0].adType,
                        c = a.livereAds[0].zoneId,
                        d = a.livereAds[0].slotId,
                        f = a.adInventorySeq,
                        g = a.livereSeq,
                        h = a.device,
                        i = a.inventoryInfo.place,
                        j = a.inventoryInfo.displayType,
                        k = a.inventoryInfo.align,
                        l = a.inventoryInfo.order,
                        m = a.inventoryInfo.width,
                        n = a.inventoryInfo.height,
                        o = i + "-" + j + "-" + k + "-" + m + "x" + n + "-" + l,
                        p = f + ":" + g + ":" + h + ":" + o,
                        q = "lv-ad-" + [i, k, l].join("-");
                    m = 0 === m ? "100%" : m + "px", n = 0 === n ? "100%" : n + "px";
                    var r = document.createElement("div");
                    r.style = "width:" + m + ";height:auto;display:inline-block;margin: 5px 0px;", r.className = q;
                    var s = {
                        width: m,
                        height: n
                    };
                    switch (b) {
                        case "coupang":
                            s.url = "https://ads-partners.coupang.com/widgets.html?id=" + c + "&width=" + m + "&height=" + n + "&subId=" + d;
                            var t = e(s);
                            return r.appendChild(t), r;
                        case "interworks":
                            s.url = "//tm.interworksmedia.co.kr/ads.sx/" + c;
                            var t = e(s);
                            return r.appendChild(t), r;
                        case "enliple":
                            s.url = "https://work.cizion.com/ad/enlipleAD.html?zoneId=" + c + "&width=" + m + "&height=" + n + "&subId=" + d;
                            var t = e(s);
                            return r.appendChild(t), r;
                        case "getnshow":
                            var u = document.createElement("img");
                            u.src = "//was.livere.me/collect?data=" + p, u.width = "0", u.height = "0", u.style = "position: absolute; top: -100px; left: -100px;", r.appendChild(u), s.url = "https://vod.shoppingcall.me/ad_shoppingCallme.php?aid=" + d;
                            var t = e(s);
                            return t.name = c, r.appendChild(t), r;
                        case "LAP":
                            s.url = "https://lap.livere.com/ad/" + c;
                            var t = e(s);
                            return t.id = "lap-frame", t.setAttribute("lap-browser-id", uuid), t.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"), r.appendChild(t), r;
                        case "adop":
                            var t = document.createElement("ins");
                            return t.className = "adsbyadop", t.setAttribute("_adop_zon", c), t.setAttribute("_adop_type", "re"), t.setAttribute("style", "width:" + m + ";height:" + n + ";display:inline-block;"), t.setAttribute("_page_url", ""), r.appendChild(t), r;
                        case "dable":
                            var t = document.createElement("div");
                            return t.setAttribute("id", "dablewidget_" + c), t.setAttribute("style", "width:" + m + ";height:" + n + ";display:inline-block;"), t.setAttribute("data-widget_id", c), r.appendChild(t), r;
                        default:
                            return r
                    }
                },
                g = function(a) {
                    ...
                    switch (b) {
                        ...
                        case "dable":
                            ...
                            }(window, document, "dable", "script"), dable("setService", e), dable("sendLogOnce"), dable("renderWidget", "dablewidget_" + c)
                    }
                },
                h = function(a) {
                    if (a && Array.isArray(a)) {
                        ...
                        if (1 !== a.length) {
                            b = 30 * a.length;
                            for (var d = 0, e = a.length; d < e; d++) b += a[d].inventoryInfo.width;
                            b += "px"
                        }
                        const h = document.createElement("div");
                        h.id = "livereAdWrapper", h.style = "width: 100%;text-align:center;";
                        const i = document.createElement("div");
                        i.id = "livereAd", i.style = "display:flex;justify-content:space-around;align-items:center;flex-wrap:wrap;max-width:" + b + ";width: 100%;margin: 0 auto;", a.map(function(a) {
                            i.appendChild(f(a)), g(a)
                        }), h.appendChild(i), c.appendChild(h)
                    }
                },
                i = function(a) {
                    var b = a && JSON.parse(a);
                    b && 200 === b.resultCode && h(b.livereAdsData)
                };
            return function(a, b, c) {
                request(LIVEREMEURL + "api/" + a, {
                    method: "POST",
                    header: {
                        "Content-Type": "application/json"
                    },
        ...
        ! function(a, b) {
            ...
            c = a.createElement(b), c.src = "https://api-city.livere.com/smartlogin", c.async = !0, d.parentNode.insertBefore(c, d)
        }(document, "script")
        ...
        Array.prototype.indexOf || (Array.prototype.indexOf = function(a, b) {
            ...
            function() {
                ...
                for (; c < a.length;) b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(c)), e = e << 6 | b, f += 6, 24 === f && (d.push(String.fromCharCode(e >> 16 & 255)), d.push(String.fromCharCode(e >> 8 & 255)), d.push(String.fromCharCode(255 & e)), f = 0, e = 0), c += 1;
                return 12 === f ? (e >>= 4, d.push(String.fromCharCode(255 & e))) : 18 === f && (e >>= 2, d.push(String.fromCharCode(e >> 8 & 255)), d.push(String.fromCharCode(255 & e))), d.join("")
        ...
        if (b) {
            ...
            if (~location.host.indexOf("tistory.com") && hasProtocol(i.refer) && (i.refer = i.refer.replace(new RegExp("^https?://", "i"), "http://")), !isObjectPropertiesNull(i)) {
                ...
                return i.title = encodeURIComponent(escape(j)), i.titleLength = j.length, i.logo = d ? d.getAttribute("content") : null, i.highlightSeq = h ? h[h.length - 1] : null, i.redirectOrigin = c.redirectOrigin || null, i.preview = !!c.preview && c.preview, i
            }
        }
    };
    ...
    return addEventListener("scroll", widget.comment.emitPositionEvent, scrollEventTarget), livere.reload = function() {
        ...
        var f = document.querySelector("#lv-container"),
            g = get("lv_comment"),
            h = get("lv_utils");
        if (f && (g && f.removeChild(g), h && document.body.removeChild(h)), variables = {}, bound = {},
            (window.livereOptions || {}).eagerLoading) return location.search.indexOf("redirectOrigin=true") > -1 ? widget.oauth.call(this) : livere.start.call(this);
        livere.loading.call(this)
